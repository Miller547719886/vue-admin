    ...
    <!-- <modal v-model="modalShow" :title="title" width="800px"> -->
      <Form ref="formValidate"
        ...
        <div class="ivu-information-box clearfix">
          ...
          <div class="f-r mt-20 mr-20">
            <Button v-if="isUpdate"
                    ...
                    @click="updateEngineer('formValidate')">保存
            </Button>
            <Button v-else
                    :loading="SubmitLoading"
        ...
        <Tabs class="mt-20" type="card" v-model="tabValue"
               :animated="false" :style="{'min-height': '500px'}">
  ...
  export default {
      ...
      return {
        ...
        ruleValidate: {
          ...
          detailedAddress: [
            ...
            {type: 'string', min: 1, max: 200, message: '详细地区不能大于200位', trigger: 'blur'}
          ],
          // accountCode: [
    ...
    watch: {
      modalShow (val) {
        ...
        if (val && (loginUtils.getUserInfo().id ===1 || loginUtils.getUserInfo().SYSTEM)) {
          this.$Notice.error({
            title: '警告提示',
            desc: `系统管理员不能新增工程师`
          })
